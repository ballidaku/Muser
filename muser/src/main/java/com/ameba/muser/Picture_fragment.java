...
public
class Picture_fragment extends Fragment implements OnClickListener, OnTouchListener
{
    ...
    public
    Picture_fragment(Context con, Video_fragment video_fragment)
    {
        this.con = con;
    ...
    /*	@Override
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            (flash=(ImageView) findViewById(R.id.flash)).setOnClickListener(this);
    ...
    View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        com.ameba.muser.Camera.which_fragment = "camera";
        ...
        ((TextView) rootView.findViewById(R.id.go_to_video)).setOnClickListener(this);
    ...
    {
//		Video_fragment newFragment = new Video_fragment();

        FragmentManager fragmentManager = getFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();

        fragmentTransaction.replace(android.R.id.content, video_fragment);
        fragmentTransaction.addToBackStack("first_new_scan");
    ...
    void refresh_camera()
    {
        ...
        setCameraDisplayOrientation(Picture_fragment.this, front_or_back_camera, camera);
    ...
    private
    Camera getCameraInstance(int type)
    {
        Camera c = null;
...
//			camwidth = width;
//			camheight = height;
            Log.e("SurfaceHolder Dimensions :" + width, "" + height);
    ...
    private
    int getCameraPictureRotation(int orientation)
    {
    ...
    private
    void setCameraPictureOrientation(Camera.Parameters params)
    {
        Camera.CameraInfo info = new Camera.CameraInfo();
        Camera.getCameraInfo(front_or_back_camera, info);
    ...
    public
    void setCameraDisplayOrientation(Fragment activity, int cameraId, android.hardware.Camera camera)
    {
    ...
    private
    class SaveToSdCard extends AsyncTask<Void, Void, Void>
    {
        Bitmap bmp = null;
        File file = null;
        FileOutputStream outStream = null;
        ...
        public
        SaveToSdCard(Bitmap bmp, File file)
        {
            this.bmp = bmp;
            this.file = file;
        }
