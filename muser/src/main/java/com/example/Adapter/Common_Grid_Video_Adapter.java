...
public class Common_Grid_Video_Adapter extends BaseAdapter
{
	Context con;
	Fragment con2;
	...
	public Common_Grid_Video_Adapter(Context con,Fragment con2, ArrayList<HashMap<String, String>> list) 
	{
		this.con = con;
		this.con2 = con2;
		this.list=list;
	...
	public View getView(final int position, View row, ViewGroup parent) 
	{
		...
		LinearLayout other_profile_lay=(LinearLayout)row.findViewById(R.id.other_profile_lay);
		...
		other_profile_lay.setOnClickListener(new OnClickListener() 
		{
