...
public class Trending_Videos_Adapter extends BaseAdapter
{
	Context con;
	Fragment con2;
	...
	public Trending_Videos_Adapter(Context con,Fragment con2,ArrayList<HashMap<String, String>> list) 
	{
		this.con = con;
		this.con2 = con2;
		this.list=list;
	...
	public View getView(final int position, View row, ViewGroup parent) 
	{
		...
		row = inflater.inflate(R.layout.custom_common_videos, parent, false);
