...
public class InstagramApp {
	...
	public InstagramApp(final Context context, String clientId, String clientSecret,
		...
		OAuthDialogListener listener = new OAuthDialogListener() 
		{
			...
			{
				if(!Util_Class.checknetwork(context))
				{
					Util_Class.show_Toast(context.getResources().getString(R.string.no_internet_connection), context);
				}
				else
				{
					getAccessToken(code);
	...
	public void authorize() {
		...
		if(!Util_Class.checknetwork(mCtx))
		{
			Util_Class.show_Toast(mCtx.getResources().getString(R.string.no_internet_connection), mCtx);
		}
		else
		{
			mDialog.show();	
