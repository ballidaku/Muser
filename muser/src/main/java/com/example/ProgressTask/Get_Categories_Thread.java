...
public class Get_Categories_Thread
{

	Context con;
	public ArrayList<HashMap<String, String>> list;// = new ArrayList<HashMap<String, String>>();

	public Get_Categories_Thread(Context con)
	{
	...
	Thread background = new Thread(new Runnable()
	{
		...
		public void run()
		{
			try
			{
				HttpPost httppost = new HttpPost(Util_Class.get_categories);
				...
				if((null != response))
				{
					try
					{
						...
						if(msg_json.equals("Success"))
						{
							...
							JSONArray jo = new JSONObject(response).getJSONArray("video_category");
							...
							Captured_Image.categories_list.addAll(list);
							Captured_Image.category_spinner.invalidate();
