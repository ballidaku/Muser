...
public class Get_Area_Of_Focus_Thread
{
	Context con;
	public ArrayList<HashMap<String, String>> list;// = new ArrayList<HashMap<String, String>>();

	public Get_Area_Of_Focus_Thread(Context con)
	{
	...
	Thread background = new Thread(new Runnable()
	{
		...
		public void run()
		{
			try
			{
				HttpPost httppost = new HttpPost(Util_Class.get_area_of_focus);
			...
			catch(Throwable t)
			{
				...
				Log.e("get_area_of_focus", "Thread  exception " + t);
			}
		}
				...
				if((null != response))
				{
					try
					{
						...
						if(msg_json.equals("Success"))
						{
							...
							JSONArray jo = new JSONObject(response).getJSONArray("area_of_focus");
							...
							Captured_Image.aof_list.addAll(list);
							Captured_Image.area_of_focus_spinner.invalidate();
