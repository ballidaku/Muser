...
public class Tab_Notification_Sessions extends Fragment
{
	Context		con;
	ListView	notification_listview;
	TextView	message;
	LinearLayout logo_lay;
	Tab_Notification_Sessions con2;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		if(savedInstanceState==null)
		{
			...
			Log.e("Where", "Tab_Notification_sessions");
		}
...
//			list.clear();
	...
	public void refresh()
	{
		...
		//new Get_Notification_ProgressTask(con,con2, "S").execute();



		if( Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB )
		{
			new Get_Notification_ProgressTask(con,con2, "S").executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
		}
		else
		{
			new Get_Notification_ProgressTask(con,con2, "S").execute();
	...
	public void set_data(ArrayList<HashMap<String, String>> list)
	{
		...
		{
			this.list = list;
			adapter = new Notification_Adapter(con, list,"S");
