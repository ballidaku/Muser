...
import com.example.Adapter.Home_Pictures_Adapter;
...
public class Tab_Trending_Pictures extends Fragment
{
	Context					con;
	Tab_Trending_Pictures con2;
	...
	void onResume()
	{
		...
		Log.e("InonResume:Tab_Trending_Pictures", rem_pref.getString("current_frag", ""));
	...
	public void refresh()
	{
		...
		Log.e("Where", "Tab_Trending_Pictures");

		//new Get_Trending_Pictures_Videos_ProgressTask(con,con2, "I").execute();


		if( Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB )
		{
			new Get_Trending_Pictures_Videos_ProgressTask(con,con2, "I").executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
		}
		else
		{
			new Get_Trending_Pictures_Videos_ProgressTask(con,con2, "I").execute();
	...
	public void set_data(ArrayList<HashMap<String, String>> list)
	{
		...
		{
			this.list = list;
			adapter = new Trending_Pictures_Adapter(con,con2, list);
