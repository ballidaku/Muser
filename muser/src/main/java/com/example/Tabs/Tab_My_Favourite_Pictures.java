...
public class Tab_My_Favourite_Pictures extends Fragment
{
	Context					con;
	Tab_My_Favourite_Pictures con2;
	...
	void onResume()
	{
		...
		Log.e("onResume:Tab_MyFavorite_Pictures", rem_pref.getString("current_frag", ""));
	...
	public void refresh()
	{
		...
		Log.e("Where", "Tab_My_Favourite_Pictures");
		Global.set_user_id(rem_pref.getString("user_id", ""));

		
		//new Get_My_Favoutite_Pictures_Videos_Users_ProgressTask(con,con2, "I").execute();

		if( Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB )
		{
			new Get_My_Favoutite_Pictures_Videos_Users_ProgressTask(con,con2, "I").executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
		}
		else
		{
			new Get_My_Favoutite_Pictures_Videos_Users_ProgressTask(con,con2, "I").execute();
